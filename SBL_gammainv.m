function [ x_post, report] = SBL_gammainv( A , Y, options )
%
...
for j1 = 1 : options.convergence.maxiter
    ...
    [ ~ , Ilocs] = findpeaks(1./gamma,'SORTSTR','descend','NPEAKS',Nsource);
    Apeak      = A(:,:,Ilocs);
...
%     drawnow
    ...
    errornorm(j1) = norm ( 1./gamma - 1./gammaOld, 1 ) / norm ( 1./gamma, 1 );
